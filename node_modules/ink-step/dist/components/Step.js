...
class Step extends React.Component {
  ...
  computeMatch() {
    const {
      ...
      delimiter,
      task
    } = this.props; // console.log(task, this.context.step.task.name, delimiter, match(task, this.context.step.task.name, delimiter))
    console.log(this.context, task, delimiter, match)
    return match(task, this.context.step.task.name, delimiter);
  }

  componentDidMount() {
    const matched = this.computeMatch(); // console.log('Step mount\n', matched, this.state.matched)
